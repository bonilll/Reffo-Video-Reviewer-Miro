...
export function SubscriptionStatus({ 
  ...
  // For paid users, show subscription management
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <CardTitle>Your {currentPlanName} Subscription</CardTitle>
                  ...
                  <div className="space-y-2">
                    ...
                    {planType !== 'pro' && (
                      <Button 
                        variant="outline" 
                        size="sm" 
                        onClick={() => onPlanChange('pro', subscription?.billingInterval || 'monthly', true)}
                        className="w-full"
                      >
                        Switch to Pro
                      </Button>
                  ...
                  <div className="space-y-2">
                    {subscription?.billingInterval !== 'yearly' && (
                      <Button 
                        variant="outline" 
                        size="sm" 
                        onClick={() => onPlanChange(planType as 'medium' | 'pro' | 'premium', 'yearly', true)}
                    ...
                    {subscription?.billingInterval !== 'monthly' && (
                      <Button 
                        variant="outline" 
                        size="sm" 
                        onClick={() => onPlanChange(planType as 'medium' | 'pro' | 'premium', 'monthly', true)}
                        className="w-full"
                      >
                        Switch to Monthly
                      </Button>
